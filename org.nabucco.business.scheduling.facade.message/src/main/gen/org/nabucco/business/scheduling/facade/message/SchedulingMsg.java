...
/**
 * SchedulingMsg<p/>Holds a single scheduling.<p/>
 *
 * @version 1.0
 * @author Nicolas Moser, PRODYNA AG, 2011-08-23
 */
public class SchedulingMsg extends ServiceMessageSupport implements ServiceMessage {
    ...
    /** Constructs a new SchedulingMsg instance. */
    public SchedulingMsg() {
        super();
        this.initDefaults();
    }
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(SchedulingMsg.getPropertyDescriptor(SCHEDULING), this.getScheduling()));
        return properties;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final SchedulingMsg other = ((SchedulingMsg) obj);
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(SchedulingMsg.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(SchedulingMsg.class).getAllProperties();
    }
}
